    ...
    <div  >
        <Card>
            ...
            <CardContent>
                ...
                return <Link key={i} to={`/quiz/${x.name.toLowerCase()}`} className='flex flex-col border hover:border-gray-200 justify-center rounded p-3 items-center bg-white'>
                            <img src={x.icon} className="w-[80px]" alt="" />
